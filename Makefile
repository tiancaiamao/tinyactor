...
SRC     = src/val.c src/vm.c src/builtin.c src/scheduler.c src/gc.c src/api.c src/net.c src/file.c src/os.c src/buf.c src/str.c src/num.c src/encoding.c src/prof.c src/tavm.c
